...
################################################################
# This is a generated script based on design: vga_interface
#
...
# source vga_interface_script.tcl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins mymux_0/i_control] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins mymux_0/o_data] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data1 [get_bd_pins mymux_0/i_data] [get_bd_pins v_axi4s_vid_out_0/vid_data]
