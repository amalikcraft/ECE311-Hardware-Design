...
/*This script by VIPIN processes the array of data from the header file generated from the MATLAB script and uploads
 * it to the Zedboard as a continuous stream of data that can be interpreted by the VGA protocol of a monitor.
 */
