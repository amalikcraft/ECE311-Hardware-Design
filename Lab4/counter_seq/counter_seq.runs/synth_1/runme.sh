...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/Lab4/counter_seq/counter_seq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_seq.tcl
