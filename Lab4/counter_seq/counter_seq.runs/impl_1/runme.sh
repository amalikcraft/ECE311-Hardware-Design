...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/Lab4/counter_seq/counter_seq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_seq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_seq.tcl -notrace
