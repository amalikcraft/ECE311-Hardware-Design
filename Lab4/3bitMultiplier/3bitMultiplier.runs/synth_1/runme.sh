...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/Lab4/3bitMultiplier/3bitMultiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_3bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_3bit.tcl
