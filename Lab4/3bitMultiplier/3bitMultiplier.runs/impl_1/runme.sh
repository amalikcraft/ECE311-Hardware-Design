...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/Lab4/3bitMultiplier/3bitMultiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_3bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_3bit.tcl -notrace
