...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/Lab4/8bitCounterDFF/8bitCounterDFF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterDFF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CounterDFF.tcl -notrace
