...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/Lab4/4bit_reg_asynch/4bit_reg_asynch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourBitRegAsync.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourBitRegAsync.tcl
