...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/lab2/bahavioral/bahavioral.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log behavioral_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source behavioral_mux.tcl
