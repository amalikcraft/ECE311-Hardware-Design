...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/lab2/bahavioral/bahavioral.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log behavioral_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source behavioral_mux.tcl -notrace
