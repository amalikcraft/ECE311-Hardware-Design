...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/dataFlow/dataFlow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dataflow.tcl
