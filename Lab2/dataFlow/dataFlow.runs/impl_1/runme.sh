...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/lab2/dataFlow/dataFlow.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dataflow.tcl -notrace
