...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/lab2/look_Ahead/look_Ahead.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log look_ahead_Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source look_ahead_Adder.tcl
