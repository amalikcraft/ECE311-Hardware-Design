...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/lab2/look_Ahead/look_Ahead.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log look_ahead_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source look_ahead_Adder.tcl -notrace
