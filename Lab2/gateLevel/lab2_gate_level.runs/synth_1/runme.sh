...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/lab2/lab2_gate_level/lab2_gate_level.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_gate.tcl
