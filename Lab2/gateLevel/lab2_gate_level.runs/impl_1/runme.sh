...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/lab2/lab2_gate_level/lab2_gate_level.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_gate.tcl -notrace
