...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/Music/Lab3/IC74138/IC74138.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IC74138.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IC74138.tcl -notrace
