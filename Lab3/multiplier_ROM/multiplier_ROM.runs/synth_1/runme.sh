...
HD_PWD='/afs/ee.cooper.edu/user/a/ahmad.malik/Music/Lab3/multiplier_ROM/multiplier_ROM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_ROM.tcl
